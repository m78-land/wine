...
/** 描述可拖动范围 */
export declare enum WineBoundEnum {
    /** 窗口范围内 */
    window = "window",
...
/** 描述可拖动方向 */
export declare enum WineDragPositionEnum {
    L = 0,
    T = 1,
    R = 2,
    B = 3,
...
/** wine实例 */
export interface WineInstance extends RenderApiComponentInstance<WineProps, WineInstanceExtend> {
}
